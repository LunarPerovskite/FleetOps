...
class RealUsageExtractor:
    ...
    @staticmethod
    async def extract_openai_usage(response_json: Dict) -> Dict:
        """
    ...
    @staticmethod
    async def extract_anthropic_usage(response_json: Dict) -> Dict:
        """
    ...
    @staticmethod
    async def extract_groq_usage(response_json: Dict) -> Dict:
        """
    ...
    @staticmethod
    async def extract_perplexity_usage(response_json: Dict) -> Dict:
        """
    ...
    @staticmethod
    async def extract_openrouter_usage(response_json: Dict, headers: Optional[Dict] = None) -> Dict:
        """
    ...
    @staticmethod
    async def extract_together_usage(response_json: Dict) -> Dict:
        """
    ...
    @staticmethod
    async def extract_ollama_usage(response_text: str, prompt_text: str) -> Dict:
        """
        Ollama does NOT return usage in response.
        
        We must estimate:
        - Input: count tokens in prompt (or estimate)
        - Output: count tokens in response (or estimate)
        ...
        return {
            ...
            "cached_tokens": 0,
            "model": "ollama",
            "has_real_usage": False,  # Estimated, not real
            "estimated": True
        }
    
    @staticmethod
    async def extract_azure_openai_usage(response_json: Dict) -> Dict:
        """
    ...
    @staticmethod
    async def extract_gemini_usage(response_json: Dict) -> Dict:
        """
    ...
    @classmethod
    async def extract_usage(cls, provider: str, response_data: Any, 
        ...
        if extractor:
            if provider == "ollama":
                return await extractor(response_data, prompt_text)
            elif provider == "openrouter":
                return await extractor(response_data, headers)
            else:
                return await extractor(response_data)
...
async def track_real_openai_request():
    ...
    usage = await RealUsageExtractor.extract_openai_usage(response.model_dump())
